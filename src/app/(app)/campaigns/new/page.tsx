...
import AssociationTypeField from "@/components/campaign/AssociationTypeField";
      ...
      <EnterMovesFocusForm action={create} className="mt-6 max-w-xl space-y-4 rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="e.g. Total shortlisting needed, reference profiles, expected CPV, budget split, ROU, total expected views, shortlisting and content creator guardrails..."
          />
        </div>
